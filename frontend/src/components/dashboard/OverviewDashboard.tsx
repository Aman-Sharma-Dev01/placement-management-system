      ...
      <div className="space-y-5">
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <button onClick={() => setActiveTab('jobs')} className="bg-emerald-600 text-white rounded-md px-3 py-1.5 text-[13px] font-medium hover:bg-emerald-700">
                Browse drives
              </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-5">
            ...
            <div className="mt-1 text-2xl font-semibold text-emerald-700">{shortlisted}</div>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-5">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-5">
            ...
            <div className="mt-3 h-1.5 rounded-full bg-gray-200 overflow-hidden">
              <div className="h-1.5 rounded-full bg-emerald-600" style={{ width: `${profileCompletion}%` }} />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden lg:col-span-2">
            <div className="p-4 border-b border-gray-100 flex items-center justify-between">
              ...
              <button onClick={() => setActiveTab('applications')} className="text-[12px] font-medium text-emerald-600 hover:underline">View all ({totalApplied})</button>
            </div>
              ...
              {myApplications.length > 0 ? myApplications.slice(0, 4).map((app) => {
                ...
                return drive ? (
                  <div key={app.id} className="flex gap-3 p-3 rounded-lg border border-gray-200 bg-gray-50">
                    <div className="w-8 h-8 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center shrink-0"><Calendar size={14} /></div>
                    <div>
      ...
      <div className="space-y-5">
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <button onClick={() => setActiveTab('students_directory')} className="bg-emerald-600 text-white rounded-md px-3 py-1.5 text-[13px] font-medium hover:bg-emerald-700">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-5"><div className="text-[11px] font-medium text-gray-500 uppercase tracking-wide">Draft / corrections</div><div className="mt-1 text-2xl font-semibold text-emerald-700">{draftStudents}</div></div>
        </div>

        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
          <div className="p-4 border-b border-gray-100 flex items-center justify-between">
            <h3 className="text-[14px] font-semibold text-gray-900">Verification queue</h3>
            <button onClick={() => setActiveTab('students_directory')} className="text-[12px] font-medium text-emerald-600 hover:underline">Open registry</button>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-[13px] border-collapse">
              <thead>
      ...
      <div className="space-y-5">
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <button onClick={() => setActiveTab('drive_create')} className="bg-emerald-600 text-white rounded-md px-3 py-1.5 text-[13px] font-medium hover:bg-emerald-700">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-5"><div className="text-[11px] font-medium text-gray-500 uppercase tracking-wide">Companies managed</div><div className="mt-1 text-2xl font-semibold text-emerald-700">{totalCompanies}</div></div>
          <div className="bg-white border border-gray-200 rounded-lg p-5"><div className="text-[11px] font-medium text-gray-500 uppercase tracking-wide">Applications received</div><div className="mt-1 text-2xl font-semibold text-emerald-700">{totalApplications}</div></div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
          <div className="p-4 border-b border-gray-100 flex items-center justify-between">
            ...
            <button onClick={() => setActiveTab('jobs')} className="text-[12px] font-medium text-emerald-600 hover:underline">Open jobs</button>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-left text-[13px] border-collapse">
              <thead>
      ...
      <div className="space-y-5">
        <div className="bg-white border border-gray-200 rounded-lg p-5">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <button onClick={() => setActiveTab('settings')} className="bg-emerald-600 text-white rounded-md px-3 py-1.5 text-[13px] font-medium hover:bg-emerald-700">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-5"><div className="text-[11px] font-medium text-gray-500 uppercase tracking-wide">Open drives</div><div className="mt-1 text-2xl font-semibold text-emerald-700">{openDrives}</div></div>
          <div className="bg-white border border-gray-200 rounded-lg p-5"><div className="text-[11px] font-medium text-gray-500 uppercase tracking-wide">Companies</div><div className="mt-1 text-2xl font-semibold text-emerald-700">{totalCompanies}</div></div>
        </div>
